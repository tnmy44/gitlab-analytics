...
(
    ...
    ON dim_crm_opportunity.dim_crm_opportunity_id = sheetload_map_ramp_deals.dim_crm_opportunity_id		

    LEFT JOIN ramp_deals					
    ON dim_crm_opportunity.dim_crm_opportunity_id = ramp_deals.dim_crm_opportunity_id				
...
(				
    ...
    ON dim_subscriptions.ramp_ssp_id = ramp_ssp_id_min_max_dates.ramp_ssp_id				
    WHERE dim_subscriptions.ramp_ssp_id IS NULL
     OR (dim_subscriptions.ramp_ssp_id IS NOT NULL 
