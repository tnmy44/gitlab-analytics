...
, prep_charge AS (
  ...
  {{ dbt_utils.group_by(n=5) }}
    ...
    SELECT
      ...
      dim_crm_account.parent_crm_account_sales_segment                                AS parent_crm_account_demographics_sales_segment,
      dim_crm_account.parent_crm_account_geo                                          AS parent_crm_account_demographics_geo,
