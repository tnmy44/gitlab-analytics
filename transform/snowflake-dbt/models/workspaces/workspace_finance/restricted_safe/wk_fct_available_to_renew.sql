...
{% for renewal_fiscal_year in renewal_fiscal_years -%}
    ...
    --  AND DATE_TRUNC('month', sub_1.subscription_created_date) = DATE_TRUNC('month', sub_2.subscription_created_date)
    --  AND sub_1.subscription_start_month != sub_2.subscription_start_month
