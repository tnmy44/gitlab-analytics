...
SELECT
payment_by_type.payment_month,
payment_by_type.payment_type,
payment_by_type.payment_amount_by_type,
all_payments.total_payment_amount,
...
payment_by_type.number_of_payments_by_type,
all_payments.total_number_of_payments,
