...
WITH sfdc_users_xf AS (
  ...
  WHERE date_actual = CURRENT_DATE
    ...
    SELECT  
       ...
       account_segment AS account_demographics_segment,
       account_geo AS account_demographics_geo,
       account_region AS account_demographics_region,
       account_area AS account_demographics_area,
       account_territory AS account_demographics_territory,
       ...
       parent_crm_account_territory AS parent_crm_account_demographics_territory,
