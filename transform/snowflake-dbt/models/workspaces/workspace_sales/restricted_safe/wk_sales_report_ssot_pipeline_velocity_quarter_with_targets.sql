{{ config(alias='report_ssot_pipeline_velocity_quarter_with_targets') }}
...
WITH report_pipeline_velocity_quarter AS (
  ...
  SELECT *
  FROM {{ref('wk_sales_report_ssot_pipeline_velocity_quarter')}}  
...
-- keys used for aggregated historical analysis
  ...
  SELECT *
  FROM {{ref('wk_sales_report_ssot_targets_totals_per_quarter')}}  
  ...
  SELECT
     ...
     -------------------------
     -- keys
     base.report_bu_subbu_division_asm_user_segment_geo_region_area_sqs_ot AS report_bu_subbu_division_asm_user_segment_geo_region_area_sqs_ot,
     -------------------------
  ...
  SELECT 
      ...
      -------------------------
      -- keys
      pv.report_bu_subbu_division_asm_user_segment_geo_region_area_sqs_ot,
      -------------------------
  ...
  SELECT 
      ...
      -------------------------
      -- keys
      o.report_bu_subbu_division_asm_user_segment_geo_region_area_sqs_ot,
      -------------------------     
  ...
  SELECT 
    ...
    pipeline_summary.report_bu_subbu_division_asm_user_segment_geo_region_area_sqs_ot
  ...
  SELECT 
    ...
    consolidated_targets_totals.report_bu_subbu_division_asm_user_segment_geo_region_area_sqs_ot
  ...
  LEFT JOIN  consolidated_targets_totals target  
    ...
    AND target.report_bu_subbu_division_asm_user_segment_geo_region_area_sqs_ot = base.report_bu_subbu_division_asm_user_segment_geo_region_area_sqs_ot
  LEFT JOIN  pipeline_summary ps  
    ...
    AND base.report_bu_subbu_division_asm_user_segment_geo_region_area_sqs_ot = ps.report_bu_subbu_division_asm_user_segment_geo_region_area_sqs_ot
