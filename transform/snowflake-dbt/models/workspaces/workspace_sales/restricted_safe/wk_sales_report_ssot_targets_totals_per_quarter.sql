...
{{ config(alias='report_ssot_targets_totals_per_quarter') }}
 ...
 SELECT
  ...
  LEFT JOIN totals_per_quarter total
    ON total.close_fiscal_quarter_date = base.close_fiscal_quarter_date
      AND total.report_bu_subbu_division_asm_user_segment_geo_region_area_sqs_ot = base.report_bu_subbu_division_asm_user_segment_geo_region_area_sqs_ot
