 ...
 SELECT
  ...
  INNER JOIN date_details close_date
    ...
    LEFT JOIN current_fiscal_year
      ...
      AND base_fields.report_user_adjusted_segment_geo_region_area_sqs_ot = current_fiscal_year.report_user_adjusted_segment_geo_region_area_sqs_ot
    ...
    LEFT JOIN  next_fiscal_year
      ON base_fields.close_day_of_fiscal_year_normalised = next_fiscal_year.close_day_of_fiscal_year_normalised
        ...
        AND base_fields.report_user_adjusted_segment_geo_region_area_sqs_ot = next_fiscal_year.report_user_adjusted_segment_geo_region_area_sqs_ot    
