...
combined AS (
  ...
  SELECT 
    ...
    actuals.dim_parent_sales_segment_id,
    actuals.dim_account_sales_segment_id,
    actuals.dim_crm_opp_owner_user_hierarchy_id,
    actuals.dim_crm_opp_owner_business_unit_stamped_id,
    actuals.dim_crm_opp_owner_sales_segment_stamped_id,
    actuals.dim_crm_opp_owner_geo_stamped_id,
    actuals.dim_crm_opp_owner_region_stamped_id,
    actuals.dim_crm_opp_owner_area_stamped_id,
    actuals.dim_crm_user_hierarchy_live_sk,
    actuals.dim_crm_user_business_unit_id,
    actuals.dim_crm_user_sales_segment_id,
    actuals.dim_crm_user_geo_id,
    actuals.dim_crm_user_region_id,
    actuals.dim_crm_user_area_id,
    actuals.dim_crm_user_hierarchy_account_user_sk,
    actuals.dim_crm_account_user_business_unit_id,
    actuals.dim_crm_account_user_sales_segment_id,
    actuals.dim_crm_account_user_geo_id,
    actuals.dim_crm_account_user_region_id,
    actuals.dim_crm_account_user_area_id,
    actuals.dim_crm_current_account_set_hierarchy_sk,
    actuals.dim_parent_sales_territory_id,
    actuals.dim_parent_industry_id,
    actuals.dim_account_sales_territory_id,
    actuals.dim_account_industry_id,
    actuals.dim_account_location_country_id,
    actuals.dim_account_location_region_id,
