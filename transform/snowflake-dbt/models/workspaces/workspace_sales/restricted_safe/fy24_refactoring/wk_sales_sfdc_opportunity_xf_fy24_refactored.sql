{{ config(alias='sfdc_opportunity_xf_fy24_refactored') }}
...
-- keys used for aggregated historical analysis
    ...
    SELECT
      ...
      -- JK 2023-01-19: calculation of business_unit, role_type, partner_category and alliance_partner for FY 24 reporting grain
      ...
      CASE
        WHEN (edm_opty.sales_qualified_source_name = 'Channel Generated' OR sales_qualified_source_name = 'Partner Generated')
            THEN 'Partner Sourced'
        WHEN (edm_opty.sales_qualified_source_name != 'Channel Generated' AND sales_qualified_source_name != 'Partner Generated')
      ...
      LOWER(CONCAT(business_unit,'-',edm_opty.report_opportunity_user_segment,'-',edm_opty.report_opportunity_user_geo,'-',edm_opty.report_opportunity_user_region,'-',edm_opty.report_opportunity_user_area,'-',edm_opty.sales_qualified_source_name,'-',edm_opty.order_type,'-',role_type,'-',partner_category,'-',alliance_partner)) AS report_bu_user_segment_geo_region_area_sqs_ot_rt_pc_ap,
    ...
    SELECT
      ...
      agg_demo_keys.key_pc,
      agg_demo_keys.key_ap,
      ...
      agg_demo_keys.key_bu_geo,
      agg_demo_keys.key_pc_bu,
      agg_demo_keys.key_ap_bu,
      agg_demo_keys.key_bu_geo_region,
      agg_demo_keys.key_bu_geo_segment,
      agg_demo_keys.key_bu_geo_rt,
      agg_demo_keys.key_pc_bu_geo,
      agg_demo_keys.key_ap_bu_geo,
      agg_demo_keys.key_bu_geo_region_area,
      agg_demo_keys.key_bu_geo_region_rt,
      agg_demo_keys.key_bu_geo_segment_region,
      agg_demo_keys.key_bu_geo_segment_rt,
      agg_demo_keys.key_bu_geo_region_area_segment,
      agg_demo_keys.key_bu_geo_region_area_rt,
      agg_demo_keys.key_bu_geo_segment_region_area,
      agg_demo_keys.key_bu_geo_segment_region_rt,
      agg_demo_keys.key_bu_geo_region_area_segment_rt,
      agg_demo_keys.key_bu_geo_segment_region_area_rt,
    ...
    LEFT JOIN agg_demo_keys
      ON oppty_final.report_bu_user_segment_geo_region_area_sqs_ot_rt_pc_ap = agg_demo_keys.report_bu_user_segment_geo_region_area_sqs_ot_rt_pc_ap
