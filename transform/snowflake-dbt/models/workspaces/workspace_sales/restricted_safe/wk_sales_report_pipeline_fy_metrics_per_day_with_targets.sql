...
-- combine the yeaar from actuals and from targets to get the table key base
  ...
  FROM source_targets
      ...
      SELECT
        ...
        targets_key.report_user_adjusted_segment_geo_region_area_sqs_ot,
      ...
      LEFT JOIN source_targets
        ON targets_key.report_user_adjusted_segment_geo_region_area_sqs_ot = source_targets.report_user_adjusted_segment_geo_region_area_sqs_ot
        AND targets_key.close_fiscal_year = source_targets.close_fiscal_year
      LEFT JOIN fy_targets
        ON targets_key.report_user_adjusted_segment_geo_region_area_sqs_ot = fy_targets.report_user_adjusted_segment_geo_region_area_sqs_ot
