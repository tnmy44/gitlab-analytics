WITH granular_data AS (
  ...
  SELECT * 
  FROM {{ ref('wk_fct_targets_actuals_granular')}}
...
unioned AS (
  ...
  SELECT 
    ...
    NULL AS total_churned_contraction_net_arr,
    NULL AS total_booked_deal_count,
    NULL AS total_churned_contraction_deal_count,
    NULL AS total_pipe_generation_net_arr,
    NULL AS total_pipe_generation_deal_count,
    NULL AS total_created_and_booked_same_quarter_net_arr,
    NULL AS adjusted_quarterly_target_net_arr,
    NULL AS adjusted_quarterly_target_deals,
    NULL AS adjusted_quarterly_target_net_arr_pipeline_created,
  ...
  SELECT 
    ...
    adjusted_quarterly_target_net_arr,
    adjusted_quarterly_target_deals,
    adjusted_quarterly_target_net_arr_pipeline_created,
    is_current_snapshot_quarter
  FROM aggregate_data
