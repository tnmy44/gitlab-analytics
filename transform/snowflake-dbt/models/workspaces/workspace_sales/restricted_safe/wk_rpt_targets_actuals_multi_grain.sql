...
unioned AS (
  ...
  SELECT 
    granular.*,
    NULL AS created_arr_quarter_total,
  ...
  SELECT      
    ...
    dim_crm_user_hierarchy_sk,
    NULL AS dim_crm_current_account_set_hierarchy_sk,
    ...
    NULL AS current_first_day_of_week,
    NULL AS current_week_of_fiscal_quarter_normalised,
    NULL AS current_week_of_fiscal_quarter,
    NULL AS created_date,
    NULL AS created_month,
    NULL AS created_fiscal_quarter_date,
    NULL AS created_fiscal_quarter_name,
    ...
    NULL AS snapshot_week_of_fiscal_quarter,
