...
unioned AS (
  ...
  SELECT 
    ...
    NULL AS dim_parent_sales_segment_id,
    NULL AS dim_account_sales_segment_id,
    NULL AS dim_crm_opp_owner_user_hierarchy_id,
    NULL AS dim_crm_opp_owner_business_unit_stamped_id,
    NULL AS dim_crm_opp_owner_sales_segment_stamped_id,
    NULL AS dim_crm_opp_owner_geo_stamped_id,
    NULL AS dim_crm_opp_owner_region_stamped_id,
    NULL AS dim_crm_opp_owner_area_stamped_id,
    NULL AS dim_crm_user_hierarchy_live_sk,
    NULL AS dim_crm_user_business_unit_id,
    NULL AS dim_crm_user_sales_segment_id,
    NULL AS dim_crm_user_geo_id,
    NULL AS dim_crm_user_region_id,
    NULL AS dim_crm_user_area_id,
    NULL AS dim_crm_user_hierarchy_account_user_sk,
    NULL AS dim_crm_account_user_business_unit_id,
    NULL AS dim_crm_account_user_sales_segment_id,
    NULL AS dim_crm_account_user_geo_id,
    NULL AS dim_crm_account_user_region_id,
    NULL AS dim_crm_account_user_area_id,
    NULL AS dim_crm_current_account_set_hierarchy_sk,
    NULL AS dim_parent_sales_territory_id,
    NULL AS dim_parent_industry_id,
    NULL AS dim_account_sales_territory_id,
    NULL AS dim_account_industry_id,
