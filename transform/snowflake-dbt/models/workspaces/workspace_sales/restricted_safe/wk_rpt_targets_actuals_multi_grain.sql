...
unioned AS (
  ...
  SELECT  
    ...
    NULL AS snapshot_id,
    NULL AS dim_sales_qualified_source_id,
    NULL AS dim_order_type_id,
    NULL AS dim_order_type_live_id,
    NULL AS dim_crm_user_hierarchy_sk,
    ...
    NULL AS crm_user_business_unit,
    NULL AS crm_user_sales_segment_region_grouped,
    NULL AS crm_user_sales_segment AS crm_account_user_sales_segment,
    NULL AS crm_user_sales_segment_grouped AS crm_account_user_sales_segment_grouped,
    NULL AS crm_user_geo AS crm_account_user_geo,
    NULL AS crm_user_region AS crm_account_user_region,
    NULL AS crm_user_area AS crm_account_user_area,
    ...
    NULL AS stage_6_awaiting_signature_date_date, -- added to maintain workspace model temporarily 
    ...
    NULL AS total_closed_opps,
    NULL AS total_closed_net_arr,
