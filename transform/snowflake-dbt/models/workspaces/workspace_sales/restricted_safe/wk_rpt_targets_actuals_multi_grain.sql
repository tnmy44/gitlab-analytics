...
unioned AS (
  ...
  SELECT      
    ...
    NULL AS dim_crm_current_account_set_sales_segment_id,
    NULL AS crm_current_account_set_sales_segment,
    NULL AS dim_crm_current_account_set_geo_id,
    NULL AS crm_current_account_set_geo,
    NULL AS dim_crm_current_account_set_region_id,
    NULL AS crm_current_account_set_region,
    NULL AS dim_crm_current_account_set_area_id,
    NULL AS crm_current_account_set_area,
    NULL AS dim_crm_current_account_set_business_unit_id,
    NULL AS crm_current_account_set_business_unit,
    crm_user_role_name AS crm_current_account_set_role_name,
    crm_user_role_level_1 AS crm_current_account_set_role_level_1,
    crm_user_role_level_2 AS crm_current_account_set_role_level_2,
    crm_user_role_level_3 AS crm_current_account_set_role_level_3,
    crm_user_role_level_4 AS crm_current_account_set_role_level_4,
    crm_user_role_level_5 AS crm_current_account_set_role_level_5,
