...
final AS (
  ...
  -- common dimension keys
    ...
    order_type_current.order_type_name AS order_type_current,
    ...
    sfdc_opportunity.snapshot_last_day_of_fiscal_quarter,
    ...
    sfdc_opportunity.closed_deals_in_snapshot_quarter,
