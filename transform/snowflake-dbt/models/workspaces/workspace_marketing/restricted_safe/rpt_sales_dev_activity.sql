...
sales_dev_hierarchy AS (
  ...
  SELECT 
    ...
    mart_crm_task.task_completed_date::DATE AS activity_date,
    dim_date.day_of_fiscal_quarter as activity_day_of_fiscal_quarter,
    dim_date.fiscal_quarter_name_fy as activity_fiscal_quarter_name,
  ...
  INNER JOIN sales_dev_hierarchy 
    ...
    AND mart_crm_task.task_completed_date::DATE = sales_dev_hierarchy.snapshot_date 
  LEFT JOIN dim_date 
    ON mart_crm_task.task_completed_date::DATE = dim_date.date_day
  WHERE activity_date >= '2022-01-01'
  ...
  SELECT
    ...
    sales_dev_hierarchy.sales_dev_rep_full_name AS sales_dev_rep_user_name,
    ...
    sales_dev_hierarchy.sales_dev_manager_full_name AS sales_dev_rep_direct_manager_name,
    ...
    sales_dev_hierarchy.sales_dev_leader_full_name AS sales_dev_rep_manager_name,
