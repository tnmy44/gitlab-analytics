...
, sales_dev_opps AS (
  ...
  SELECT 
    ...
    mart_crm_opportunity_stamped_hierarchy_hist.pipeline_created_month,
    mart_crm_opportunity_stamped_hierarchy_hist.pipeline_created_fiscal_quarter_name, 
    mart_crm_opportunity_stamped_hierarchy_hist.pipeline_created_fiscal_year,
