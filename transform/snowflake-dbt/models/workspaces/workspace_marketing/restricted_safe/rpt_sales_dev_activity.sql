...
, sales_dev_opps AS (
  ...
  SELECT 
    ...
    opportunity_snapshot_hierarchy.sales_dev_rep_user_full_name as sales_dev_user_full_name,
    ...
    opportunity_snapshot_hierarchy.sales_dev_rep_manager_full_name,
    ...
    opportunity_snapshot_hierarchy.sales_dev_rep_leader_full_name,
