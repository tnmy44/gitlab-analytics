...
SELECT DISTINCT
     arr_month
	,mart_arr_all_account_id as dim_crm_account_id
    ,max_ping_created_at
	...
	,CASE WHEN account_level_license_utilization_color = 'Green' THEN 88
		  ...
		  ELSE NULL END AS gs_license_utilization_color_value
	,CASE WHEN account_level_user_engagement_color = 'Green' THEN 88
		  ...
		  ELSE NULL END AS gs_user_engagement_color_value
	,CASE WHEN account_level_scm_color = 'Green' THEN 88
		  ...
		  ELSE NULL END AS gs_scm_color_value
	,CASE WHEN account_level_ci_color = 'Green' THEN 88
		  ...
		  ELSE NULL END AS gs_ci_color_value
	,CASE WHEN account_level_cd_color = 'Green' THEN 88
		  ...
		  ELSE NULL END AS gs_cd_color_value
	,CASE WHEN account_level_security_color = 'Green' THEN 88
		  ...
		  ELSE NULL END AS gs_security_color_value
