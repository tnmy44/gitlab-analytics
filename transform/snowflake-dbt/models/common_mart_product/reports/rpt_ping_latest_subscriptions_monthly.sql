...
*/
  ...
  SELECT
    ...
    IFNULL(joined_subscriptions.ping_delivery_type, 'Self-Managed')                                         AS ping_delivery_type, -- Hardcodding to sself-managed until next MR where dedicated will be changed to SaaS delivery type
