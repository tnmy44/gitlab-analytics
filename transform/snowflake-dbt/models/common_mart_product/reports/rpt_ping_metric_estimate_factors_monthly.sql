...
, final AS (
  ...
  SELECT
      {{ dbt_utils.surrogate_key(['ping_created_date_month', 'metrics_path', 'ping_edition', 'estimation_grain', 'ping_delivery_type', 'ping_deployment_type']) }}          AS ping_metric_estimate_factors_monthly_id,
