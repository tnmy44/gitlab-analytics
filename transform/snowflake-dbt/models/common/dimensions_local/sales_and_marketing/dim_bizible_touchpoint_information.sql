...
, bizible_mql_touchpoint_information_base AS (
    ...
    SELECT DISTINCT
        ...
        ROW_NUMBER () OVER (PARTITION BY fct_crm_person.sfdc_record_id ORDER BY prep_crm_touchpoint.bizible_touchpoint_date DESC) AS touchpoint_order_by_person
    FROM fct_crm_person
