WITH final AS (
  ...
  SELECT 
    {{ dbt_utils.surrogate_key(['employee_id', 'team_id', 'position_effective_date', 'position_date_initiated']) }}  AS team_member_position_pk,
    ...
    prep_team_member_position.position_date_initiated
