...
SELECT
  ...
  metrics.business_unit_name,
  metrics.dim_sales_segment_id,
  metrics.sales_segment_name,
  metrics.dim_geo_id,
  metrics.geo_name,
  ...
  metrics.area_name,
  metrics.role_name,
  metrics.role_level_1,
  metrics.role_level_2,
  metrics.role_level_3,
  metrics.role_level_4,
  metrics.role_level_5,
  metrics.email_hash,
