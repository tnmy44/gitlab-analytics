...
{{ simple_cte([
 ...
 , smau_metrics AS (
    ...
    SELECT
      ...
      smau.analytics_28_days_user,
      smau.issues_edit_28_days_user,
      smau.user_packages_28_days_user,
      smau.terraform_state_api_28_days_user,
      smau.incident_management_28_days_user,
      -- Wave 3.2
