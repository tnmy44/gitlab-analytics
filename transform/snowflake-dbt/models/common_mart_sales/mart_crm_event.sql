...
, final AS (
  ...
  SELECT
    ...
    dim_crm_event.attributed_active_sequence,
    dim_crm_event.call_recording,
    dim_crm_event.event_description, 
    dim_crm_event.duration_time_in_minutes, 
    dim_crm_event.event_subtype,
    dim_crm_event.meeting_source, 
    dim_crm_event.persona_functions,
    dim_crm_event.persona_levels,
