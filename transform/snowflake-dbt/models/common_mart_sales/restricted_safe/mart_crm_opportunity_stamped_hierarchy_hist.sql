...
, final AS (
    ...
    SELECT
      ...
      dim_crm_opportunity.sao_crm_account_owner_stamped_name,
       CASE
        ...
        WHEN dim_date_sao_date.fiscal_year < dim_date_sao_date.current_fiscal_year AND fct_crm_opportunity.is_hybrid_account_owner_opp = 1
          THEN dim_crm_account.parent_crm_account_demographics_sales_segment
      ...
      CASE
        ...
        WHEN dim_date_sao_date.fiscal_year < dim_date_sao_date.current_fiscal_year AND fct_crm_opportunity.is_hybrid_account_owner_opp = 1
          THEN dim_crm_account.parent_crm_account_demographics_sales_segment_grouped
      ...
      CASE
        ...
        WHEN dim_date_sao_date.fiscal_year < dim_date_sao_date.current_fiscal_year AND fct_crm_opportunity.is_hybrid_account_owner_opp = 1
          THEN dim_crm_account.parent_crm_account_demographics_geo
      ...
      CASE
        ...
        WHEN dim_date_sao_date.fiscal_year < dim_date_sao_date.current_fiscal_year AND fct_crm_opportunity.is_hybrid_account_owner_opp = 1
          THEN dim_crm_account.parent_crm_account_demographics_region
      ...
      CASE
        ...
        WHEN dim_date_sao_date.fiscal_year < dim_date_sao_date.current_fiscal_year AND fct_crm_opportunity.is_hybrid_account_owner_opp = 1
          THEN dim_crm_account.parent_crm_account_demographics_area
      ...
      CASE
        ...
        WHEN dim_date_sao_date.fiscal_year < dim_date_sao_date.current_fiscal_year AND fct_crm_opportunity.is_hybrid_account_owner_opp = 1
          THEN dim_crm_account.parent_crm_account_demographics_segment_region_stamped_grouped
      ...
      CASE
        ...
        WHEN dim_date_close_date.fiscal_year < dim_date_close_date.current_fiscal_year AND fct_crm_opportunity.is_hybrid_account_owner_opp = 1
          THEN dim_crm_account.parent_crm_account_demographics_business_unit
