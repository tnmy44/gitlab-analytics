...
, final AS (
  ...
  SELECT 
    ...
    mart_crm_opportunity_daily_snapshot.account_business_unit AS account_business_unit_snapshot,
    mart_crm_opportunity.account_business_unit AS account_business_unit_live,
    mart_crm_opportunity_daily_snapshot.account_role_type AS account_role_type_snapshot,
    mart_crm_opportunity.account_role_type AS account_role_type_live,
