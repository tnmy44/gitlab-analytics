...
, final AS (
  ...
  SELECT 
    ...
    mart_crm_opportunity_daily_snapshot.parent_crm_account_geo AS account_geo_snapshot,
    mart_crm_opportunity.parent_crm_account_geo AS account_geo_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_region AS account_region_snapshot,
    mart_crm_opportunity.parent_crm_account_region AS account_region_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_area AS account_area_snapshot,
    mart_crm_opportunity.parent_crm_account_area AS account_area_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_sales_territory AS account_territory_snapshot,
    mart_crm_opportunity.parent_crm_account_sales_territory AS account_territory_live,
    ...
    mart_crm_opportunity_daily_snapshot.parent_crm_account_geo AS parent_crm_account_geo_snapshot,
    mart_crm_opportunity.parent_crm_account_geo AS parent_crm_account_geo_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_region AS parent_crm_account_region_snapshot,
    mart_crm_opportunity.parent_crm_account_region AS parent_crm_account_region_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_area AS parent_crm_account_area_snapshot,
    mart_crm_opportunity.parent_crm_account_area AS parent_crm_account_area_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_sales_territory AS parent_crm_account_sales_territory_snapshot,
    mart_crm_opportunity.parent_crm_account_sales_territory AS parent_crm_account_sales_territory_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_business_unit AS account_business_unit_snapshot,
    mart_crm_opportunity.parent_crm_account_business_unit AS account_business_unit_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_role_type AS account_role_type_snapshot,
    mart_crm_opportunity.parent_crm_account_role_type AS account_role_type_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_max_family_employee AS parent_crm_account_max_family_employee_snapshot,
    mart_crm_opportunity.parent_crm_account_max_family_employee AS parent_crm_account_max_family_employee_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_upa_country AS parent_crm_account_upa_country_snapshot,
    mart_crm_opportunity.parent_crm_account_upa_country AS parent_crm_account_upa_country_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_upa_state AS parent_crm_account_upa_state_snapshot,
    mart_crm_opportunity.parent_crm_account_upa_state AS parent_crm_account_upa_state_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_upa_city AS parent_crm_account_upa_city_snapshot,
    mart_crm_opportunity.parent_crm_account_upa_city AS parent_crm_account_upa_city_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_upa_street AS parent_crm_account_upa_street_snapshot,
    mart_crm_opportunity.parent_crm_account_upa_street AS parent_crm_account_upa_street_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_upa_postal_code AS parent_crm_account_upa_postal_code_snapshot,
    mart_crm_opportunity.parent_crm_account_upa_postal_code AS parent_crm_account_upa_postal_code_live,
    mart_crm_opportunity_daily_snapshot.crm_account_employee_count AS crm_account_employee_count_snapshot,
    mart_crm_opportunity.crm_account_employee_count AS crm_account_employee_count_live,
