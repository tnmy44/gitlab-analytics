...
, final AS (
  ...
  SELECT 
    ...
    mart_crm_opportunity_daily_snapshot.parent_crm_account_geo AS account_demographics_geo_snapshot,
    mart_crm_opportunity.parent_crm_account_geo AS account_demographics_geo_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_region AS account_demographics_region_snapshot,
    mart_crm_opportunity.parent_crm_account_region AS account_demographics_region_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_area AS account_demographics_area_snapshot,
    mart_crm_opportunity.parent_crm_account_area AS account_demographics_area_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_sales_territory AS account_demographics_territory_snapshot,
    mart_crm_opportunity.parent_crm_account_sales_territory AS account_demographics_territory_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_sales_segment AS parent_crm_account_demographics_sales_segment_snapshot,
    mart_crm_opportunity.parent_crm_account_sales_segment AS parent_crm_account_demographics_sales_segment_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_geo AS parent_crm_account_demographics_geo_snapshot,
    mart_crm_opportunity.parent_crm_account_geo AS parent_crm_account_demographics_geo_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_region AS parent_crm_account_demographics_region_snapshot,
    mart_crm_opportunity.parent_crm_account_region AS parent_crm_account_demographics_region_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_area AS parent_crm_account_demographics_area_snapshot,
    mart_crm_opportunity.parent_crm_account_area AS parent_crm_account_demographics_area_live,
    mart_crm_opportunity_daily_snapshot.parent_crm_account_sales_territory AS parent_crm_account_demographics_territory_snapshot,
    mart_crm_opportunity.parent_crm_account_sales_territory AS parent_crm_account_demographics_territory_live,
