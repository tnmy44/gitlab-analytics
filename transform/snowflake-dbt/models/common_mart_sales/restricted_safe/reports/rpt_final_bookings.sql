...
final AS (
  ...
  SELECT
    ...
    base.crm_user_sales_segment,
    base.crm_user_sales_segment_grouped,
    base.crm_user_business_unit,
    base.crm_user_geo,
    base.crm_user_region,
    base.crm_user_area,
    base.crm_user_sales_segment_region_grouped,
    base.crm_user_role_name,
    base.crm_user_role_level_1,
    base.crm_user_role_level_2,
    base.crm_user_role_level_3,
    base.crm_user_role_level_4,
    base.crm_user_role_level_5,
