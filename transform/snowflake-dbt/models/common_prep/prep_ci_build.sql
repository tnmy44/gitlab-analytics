...
, gitlab_dotcom_ci_builds_source AS (
    ...
    SELECT
      ...
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = 10000 THEN 'protected_environment_failure'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = 10001 THEN 'insufficient_bridge_permissions'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = 10002 THEN 'downstream_bridge_project_not_found'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = 10003 THEN 'invalid_bridge_trigger'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = 10004 THEN 'upstream_bridge_project_not_found'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = 10005 THEN 'insufficient_upstream_permissions'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = 10006 THEN 'bridge_pipeline_is_child_pipeline'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = 10007 THEN 'donstream_pipeline_creation_failed'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = 10008 THEN 'secrets_provider_not_found'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = 10009 THEN 'reached_max_descendant_pipelines_depth'
