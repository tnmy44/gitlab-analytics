...
, gitlab_dotcom_ci_builds_source AS (
    ...
    SELECT
      ...
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '8' THEN 'job_execution_timeout'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '9' THEN 'archived_failure' 
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '10' THEN 'unmet_prerequisites'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '11' THEN 'scheduler_failure'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '12' THEN 'data_integrity_failure'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '13' THEN 'forward_deployment_failure'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '14' THEN 'user_blocked'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '15' THEN 'project_deleted'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '16' THEN 'ci_quota_exceeded'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '17' THEN 'pipeline_loop_detected'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '18' THEN 'no_matching_runner'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '19' THEN 'trace_size_exceeded'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '20' THEN 'builds_disabled'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '21' THEN 'environment_creation_failure'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '22' THEN 'deployment_rejected'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '23' THEN 'failed_outdated_deployment_job'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1000' THEN 'protected_environment_failure'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1001' THEN 'insufficient_bridge_permissions'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1002' THEN 'downstream_bridge_project_not_found'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1003' THEN 'invalid_bridge_trigger'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1004' THEN 'upstream_bridge_project_not_found'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1005' THEN 'insufficient_upstream_permissions'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1006' THEN 'bridge_pipeline_is_child_pipeline'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1007' THEN 'donstream_pipeline_creation_failed'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1008' THEN 'secrets_provider_not_found'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1009' THEN 'reached_max_descendant_pipelines_depth'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1010' THEN 'ip_restriction_failure'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1011' THEN 'reached_max_pipeline_hierarchy_size'
      WHEN gitlab_dotcom_ci_builds_source.failure_reason = '1012' THEN 'reached_downstream_pipeline_trigger_rate_limit'
