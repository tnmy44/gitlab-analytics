...
, first_contact  AS (
    ...
    SELECT
      ...
      sfdc_opportunity_snapshots_source.next_steps                                                                  AS next_steps,
      sfdc_opportunity_snapshots_source.auto_renewal_status                                                         AS auto_renewal_status,
      sfdc_opportunity_snapshots_source.qsr_notes                                                                   AS qsr_notes,
      sfdc_opportunity_snapshots_source.qsr_status                                                                  AS qsr_status,
      sfdc_opportunity_snapshots_source.manager_confidence                                                          AS manager_confidence,
      sfdc_opportunity_snapshots_source.renewal_risk_category                                                       AS renewal_risk_category,
      sfdc_opportunity_snapshots_source.renewal_swing_arr                                                           AS renewal_swing_arr,
      sfdc_opportunity_snapshots_source.renewal_manager                                                             AS renewal_manager, 
      sfdc_opportunity_snapshots_source.renewal_forecast_health                                                     AS renewal_forecast_health,
    ...
    SELECT
      ...
      sfdc_opportunity_source.auto_renewal_status                                                           AS auto_renewal_status,
      sfdc_opportunity_source.qsr_notes                                                                     AS qsr_notes,
      sfdc_opportunity_source.qsr_status                                                                    AS qsr_status,
      sfdc_opportunity_source.manager_confidence                                                            AS manager_confidence,
      sfdc_opportunity_source.renewal_risk_category                                                         AS renewal_risk_category,
      sfdc_opportunity_source.renewal_swing_arr                                                             AS renewal_swing_arr,
      sfdc_opportunity_source.renewal_manager                                                               AS renewal_manager, 
      sfdc_opportunity_source.renewal_forecast_health                                                       AS renewal_forecast_health,
