...
, first_contact  AS (
  ...
  {{dbt_utils.group_by(n=6)}}
    ...
    SELECT
      ...
      sfdc_opportunity_snapshots_source.xdr_net_arr_stage_1                                                         AS xdr_net_arr_stage_1,
      sfdc_opportunity_snapshots_source.xdr_net_arr_stage_3                                                         AS xdr_net_arr_stage_3,
    ...
    SELECT
      ...
      sfdc_opportunity_source.xdr_net_arr_stage_1                                                           AS xdr_net_arr_stage_1,
      sfdc_opportunity_source.xdr_net_arr_stage_3                                                           AS xdr_net_arr_stage_3,
