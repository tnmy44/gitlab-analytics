WITH source AS (
    ...
    -- Task infomation
      ...
      source.attributed_active_sequence,
      source.call_recording,
      source.event_description, 
      source.duration_time_in_minutes, 
      ...
      FIRST_VALUE(source.event_created_date) OVER (PARTITION BY source.related_opportunity_id ORDER BY source.event_created_date ASC) AS first_opportunity_event_created_date,
