WITH final AS (
    ...
    SELECT
        ...
        path_factory_assets_viewed_c AS path_factory_assets_viewed_count,
        path_factory_content_count_c AS path_factory_content_count,
        path_factory_engagement_score_c AS path_factory_engagement_score,
        path_factory_engagement_time_c AS path_factory_engagement_time,
        path_factory_query_string_c AS path_factory_query_string,
        ...
        mkto_si_add_to_marketo_campaign_c AS marketo_add_to_marketo_campaign,
        created_date_time_c AS marketo_created_date_time,
        path_factory_experience_name_c AS path_factory_experience_name,
        previous_nurture_reason_c AS previous_nurture_reason,
        path_factory_asset_type_c AS path_factory_asset_type,
        path_factory_content_list_c AS path_factory_content_list,
        path_factory_funnel_state_c AS path_factory_funnel_state,
        path_factory_topic_list_c AS path_factory_topic_list,
        ...
        all_remote_function,
        all_remote_role,
        reasonfor_all_remote AS reason_for_all_remote,
        public_sector_partner_c AS public_sector_partner,
        initial_start_date_c AS initial_start_date,
        original_source_type,
        registration_source_type,
        gs_plan_active_c AS is_gs_plan_active,
        products_purchased_c AS products_purchased,
        license_utilization_c AS license_utilization,
