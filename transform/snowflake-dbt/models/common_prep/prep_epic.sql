...
, gitlab_dotcom_epics_dedupe_source AS (
    ...
    SELECT 
      ...
      IFF(prep_namespace.visibility_level = 'private',
        'private - masked',
      ...
      prep_namespace.namespace_is_internal                                                   AS is_internal_epic,
    ...
    LEFT JOIN prep_namespace_plan_hist
        ON prep_namespace.ultimate_parent_namespace_id = prep_namespace_plan_hist.dim_namespace_id
