...
, joined AS (
    ...
    SELECT
      ...
      {{ dbt_utils.surrogate_key(['fct_crm_attribution_touchpoint.dim_crm_person_id','dim_campaign.dim_campaign_id','dim_crm_touchpoint.bizible_touchpoint_date_time']) }} AS tp_unique_id,
