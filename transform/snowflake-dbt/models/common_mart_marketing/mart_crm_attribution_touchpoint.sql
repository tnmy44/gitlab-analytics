...
, joined AS (
    ...
    SELECT
      ...
      dim_crm_touchpoint.touchpoint_offer_type AS attribution_touchpoint_offer_type,
      dim_crm_touchpoint.touchpoint_offer_type_grouped AS attribution_touchpoint_offer_type_grouped,
