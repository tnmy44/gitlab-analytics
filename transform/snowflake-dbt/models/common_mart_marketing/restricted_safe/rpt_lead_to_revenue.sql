...
, person_base_with_tp AS (
  ...
  --Touchpoint Data
      ...
      COALESCE(person_base_with_tp.marketing_channels,opp_base_with_batp.marketing_channels) AS marketing_channels,
      opp_base_with_batp.marketing_channels AS opp_marketing_channels,
