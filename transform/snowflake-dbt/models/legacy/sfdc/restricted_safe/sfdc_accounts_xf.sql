WITH sfdc_account AS (
    ...
    sfdc_account.account_demographics_sales_segment                                      AS upa_demographics_segment,
    sfdc_account.account_demographics_geo                                                AS upa_demographics_geo,
    sfdc_account.account_demographics_region                                             AS upa_demographics_region,
    sfdc_account.account_demographics_area                                               AS upa_demographics_area,
    sfdc_account.account_demographics_territory                                          AS upa_demographics_territory
