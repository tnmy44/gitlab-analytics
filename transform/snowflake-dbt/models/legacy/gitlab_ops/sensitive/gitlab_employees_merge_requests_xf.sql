...
, joined AS (
    ...
    SELECT
      ...
      gitlab_dotocom_merge_requests.merge_request_id,
      gitlab_dotocom_merge_requests.merge_request_internal_id                             AS merge_request_iid,
      gitlab_dotocom_merge_requests.merge_request_state,
      gitlab_dotocom_merge_requests.merge_request_status,
      gitlab_dotocom_merge_requests.created_at,
      gitlab_dotocom_merge_requests.merged_at,
      ...
      gitlab_dotocom_merge_requests.is_part_of_product,
