...
SELECT 
  ...
  resources_and_transfer.value['quantity']['value']::FLOAT AS resource_quantitiy_value,
  resources_and_transfer.value['quantity']['formatted_value']::VARCHAR AS formated_quantitiy_value,
