...
combined AS (
  ...
  SELECT 
    ...
    COALESCE(project_description, internal_project_description)                 AS project_description,
    project_import_source,
    project_issues_template,
    project_build_coverage_regex, 
    COALESCE(project_name, internal_project_name)                               AS project_name,
    COALESCE(project_path, internal_project_path)                               AS project_path,
    COALESCE(project_import_url, internal_project_import_url)                   AS project_import_url,
    project_merge_requests_template,
    COALESCE(created_at, internal_created_at)                                   AS created_at,
    COALESCE(updated_at, internal_updated_at)                                   AS updated_at,
    creator_id,
    COALESCE(namespace_id, internal_namespace_id)                               AS namespace_id,
    last_activity_at,
    visibility_level,
    archived,
    has_avatar,
