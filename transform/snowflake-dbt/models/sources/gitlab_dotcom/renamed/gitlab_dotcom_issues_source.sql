...
combined AS (
  ...
  SELECT
    COALESCE(issue_id, internal_issue_id) AS issue_id,
    COALESCE(issue_iid, internal_issue_iid) AS issue_iid,
    author_id,
    COALESCE(project_id, internal_project_id) AS project_id,
    milestone_id,
    sprint_id,
    updated_by_id,
    last_edited_by_id,
    ...
    issue_closed_at,
    is_confidential,
    COALESCE(issue_title, internal_issue_title) AS issue_title,
    COALESCE(issue_description, internal_issue_description) AS issue_description,
    state,
    weight,
    due_date,
    lock_version,
