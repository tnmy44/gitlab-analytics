...
renamed AS (
  ...
  SELECT
    ...
    "MRRGROSSAMOUNT"::NUMBER                                        AS mrr_gross_amount,
    "MRRNETAMOUNT"::NUMBER                                          AS mrr_net_amount,
    "MRRDISCOUNTAMOUNT"::NUMBER                                     AS mrr_discount_amount,
    "TCVGROSSAMOUNT"::NUMBER                                        AS tcv_gross_amount,
    "TCVNETAMOUNT"::NUMBER                                          AS tcv_net_amount,
    "TCVDISCOUNTAMOUNT"::NUMBER                                     AS tcv_discount_amount,
