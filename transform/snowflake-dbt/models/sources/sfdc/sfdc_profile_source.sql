    ...
    FROM {{ source('salesforce', 'profile') }}
       ...
       SELECT
         ...
         --info 
          ...
          permissionsauthorapex	AS	is_is_permissions_author_apex,
          ...
          permissionsviewcontent	AS	is_permissionsviewcontent,
          permissionsviewcustomersentiment	AS	is_permissions_viewcustomersentiment,
          permissionsviewdataassessment	AS	is_permissions_viewdataassessment,
          ...
          permissionsviewroles	AS	is_permissions_viewroles,
          permissionsviewsetup	AS	is_permissions_viewsetup,
