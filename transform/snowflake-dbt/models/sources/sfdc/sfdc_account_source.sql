...
renamed AS (
  ...
  SELECT
    ...
    --6 Sense Fields
    x6sense_6qa__c AS 6_sense_6_qa,
    riskrate_third_party_guid__c AS risk_rate_guid,
    x6sense_account_profile_fit__c AS 6_sense_account_profile_fit,
    x6sense_account_reach_score__c AS 6_sense_account_reach_score,
    x6sense_account_profile_score__c AS 6_sense_account_profile_score,
    x6sense_account_buying_stage__c AS 6_sense_account_buying_stage,
    x6sense_account_numerical_reach_score__c AS 6_sense_account_numerical_reach_score,
    x6sense_account_update_date__c AS 6_sense_account_update_date,
    x6sense_account_6qa_end_date__c AS 6_sense_account_6_qa_end_date,
    x6sense_account_6qa_age_in_days__c AS 6_sense_account_6_qa_age_days,
    x6sense_account_6qa_start_date__c AS 6_sense_account_6_qa_start_date,
    x6sense_account_intent_score__c AS 6_sense_account_intent_score,
    x6sense_segments__c AS 6_sense_segments,
