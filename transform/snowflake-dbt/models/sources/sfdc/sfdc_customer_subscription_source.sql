WITH source AS (
    ...
    SELECT
      ...
      closed_lost_renewal__c                    AS closed_lost_renewal,
      createdbyid                               AS created_by_id,
      createddate                               AS created_date,
      current_open_renewal__c                   AS current_open_renewal,
      ...
      current_zuora_sub_id__c                   AS current_zuora_sub_id,
      ...
      linkage_problem__c                        AS linkage_problem,
      name                                      AS name,
      ownerid                                   AS owner_id,
      plan_name__c                              AS plan_name,
      renewal_finder_skip__c                    AS renewal_finder_skip,
      renewal_finder_story__c                   AS renewal_finder_story,
      renewal_opportunity_trigger__c            AS renewal_opportunity_trigger,
      seat_price__c                             AS seat_price,
      subscription_train_car__c                 AS subscription_train_car,
      subscription_type__c                      AS subscription_type,
      systemmodstamp                            AS system_mod_stamp,
      x14_days_past_end_date__c                 AS x14_days_past_end_date,
      ...
      pause_auto_renewal__c                     AS pause_auto_renewal,    
      super_sonics_toggle_result__c             AS super_sonics_toggle_result,
      pause_seat_reconciliation__c              AS pause_seat_reconciliation,
      ...
      current_open_renewal_id_18__c             AS current_open_renewal_id_18,
