...
flattened AS (
  ...
  SELECT
    ...
    parse_ga4_objarray(value['user_properties'])['ssense_employee_range']::VARCHAR   AS ssense_employee_range,
    parse_ga4_objarray(value['user_properties'])['ssense_confidence']::VARCHAR       AS ssense_confidence,
    parse_ga4_objarray(value['user_properties'])['ssense_country']::VARCHAR          AS ssense_country,
    parse_ga4_objarray(value['user_properties'])['ssense_blacklisted']::VARCHAR      AS ssense_blacklisted,
    parse_ga4_objarray(value['user_properties'])['ssense_sales_segment']::VARCHAR    AS ssense_sales_segment,
    parse_ga4_objarray(value['user_properties'])['ssense_company']::VARCHAR          AS ssense_company,
    parse_ga4_objarray(value['user_properties'])['ssense_industry']::VARCHAR         AS ssense_industry,
    parse_ga4_objarray(value['user_properties'])['ssense_revenue_range']::VARCHAR    AS ssense_revenue_range,
    parse_ga4_objarray(value['user_properties'])['browser_width_height']::VARCHAR    AS browser_width_height,
