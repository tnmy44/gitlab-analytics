...
parsed AS (
  ...
  FROM
    source pq_0,
    LATERAL FLATTEN(input => pq_0.jsontext['stage_group_error_budget_seconds_spent']) pq_1,
    LATERAL FLATTEN(input => pq_0.jsontext['stage_group_error_budget_seconds_spent']['body']['data']['result'], outer => TRUE) pq_2
