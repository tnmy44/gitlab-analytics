...
SELECT     
  ...
  value['discount_edp_discount']::NUMERIC as discount_edp_discount,
  value['discount_total_discount']::NUMERIC as discount_total_discount,
  ...
  value['line_item_blended_cost']::NUMERIC as line_item_blended_cost,
  ...
  value['line_item_net_unblended_cost']::NUMERIC as line_item_net_unblended_cost,
  value['line_item_net_unblended_rate']::VARCHAR as line_item_net_unblended_rate,
  value['line_item_normalization_factor']::NUMERIC as line_item_normalization_factor,
  value['line_item_normalized_usage_amount']::NUMERIC as line_item_normalized_usage_amount,
  ...
  value['line_item_unblended_cost']::NUMERIC as line_item_unblended_cost,
  ...
  value['line_item_usage_amount']::NUMERIC as line_item_usage_amount,
  ...
  value['pricing_public_on_demand_cost']::NUMERIC as pricing_public_on_demand_cost,
  ...
  value['reservation_amortized_upfront_cost_for_usage']::NUMERIC as reservation_amortized_upfront_cost_for_usage,
  value['reservation_amortized_upfront_fee_for_billing_period']::NUMERIC as reservation_amortized_upfront_fee_for_billing_period,
  value['reservation_effective_cost']::NUMERIC as reservation_effective_cost,
  ...
  value['reservation_net_amortized_upfront_cost_for_usage']::NUMERIC as reservation_net_amortized_upfront_cost_for_usage,
  value['reservation_net_amortized_upfront_fee_for_billing_period']::NUMERIC as reservation_net_amortized_upfront_fee_for_billing_period,
  value['reservation_net_effective_cost']::NUMERIC as reservation_net_effective_cost,
  value['reservation_net_recurring_fee_for_usage']::NUMERIC as reservation_net_recurring_fee_for_usage,
  value['reservation_net_unused_amortized_upfront_fee_for_billing_period']::NUMERIC as reservation_net_unused_amortized_upfront_fee_for_billing_period,
  value['reservation_net_unused_recurring_fee']::NUMERIC as reservation_net_unused_recurring_fee,
  value['reservation_net_upfront_value']::NUMERIC as reservation_net_upfront_value,
  ...
  value['reservation_recurring_fee_for_usage']::NUMERIC as reservation_recurring_fee_for_usage,
  ...
  value['reservation_unused_amortized_upfront_fee_for_billing_period']::NUMERIC as reservation_unused_amortized_upfront_fee_for_billing_period,
  value['reservation_unused_normalized_unit_quantity']::NUMERIC as reservation_unused_normalized_unit_quantity,
  value['reservation_unused_quantity']::NUMERIC as reservation_unused_quantity,
  value['reservation_unused_recurring_fee']::NUMERIC as reservation_unused_recurring_fee,
  value['reservation_upfront_value']::NUMERIC as reservation_upfront_value,
  value['savings_plan_amortized_upfront_commitment_for_billing_period']::NUMERIC as savings_plan_amortized_upfront_commitment_for_billing_period,
