WITH source AS (
    ...
    SELECT
      ...
      product_rate_plan_number::VARCHAR         AS product_rate_plan_number,
      prpcategory_c:: VARCHAR                   AS product_rate_plan_category,
      guided_selling_c::VARCHAR                 AS guided_selling,
      legacy_tier_uidisplay_c::VARCHAR         AS legacy_tier,
