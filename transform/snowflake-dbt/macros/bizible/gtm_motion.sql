...
CASE
 ...
 WHEN  (bizible_touchpoint_type = 'Web Form' 
  ...
  WHEN (bizible_touchpoint_type = 'Web Form' --added 2021-11-22 MSandP: 585
   ...
   OR (camp.campaign_parent_id = '7014M000001vm9KQAQ' AND bizible_ad_campaign_name ILIKE '%github%') --added 2022-09-28 Agnes O MS & P issue 897
  ...
  WHEN (bizible_touchpoint_type = 'Web Form' 
    ...
    OR bizible_ad_campaign_name ILIKE '%singleappci%')) --- Added by AO demand gen issue 2262
    THEN 'CI Use Case'
  WHEN (bizible_touchpoint_type = 'Web Form' 
...
ELSE NULL END AS gtm_motion bizible_integrated_campaign_grouping,
