...
Open Quarter Plus 1 Historical AGGREGATED
...
opty_base AS (
    ...
    WHERE
        opty.close_fiscal_quarter_date = DATEADD(MONTH, 3, current_quarter_date.current_fiscal_quarter_date)
...
snap_base AS (
    ...
    WHERE
        ...
        AND snap.close_fiscal_quarter_date = DATEADD(MONTH, 3, snap.snapshot_fiscal_quarter_date)
