...
def test_handle_response(adaptive_obj):
    """Test _base_xml()"""
    response = Mock()
    ...
    """
    export_output = adaptive_obj.handle_response(response)
...
def test_iterate_versions(adaptive_obj):
    """
    ...
    adaptive_obj._iterate_versions(versions, version_reports)
...
def test_filter_for_subfolder(adaptive_obj):
    versions = [
        {"@id": "883", "@name": "FY22 - 2+10 Forecast", "@type": "PLANNING"},
        {
            "@id": "806",
    ...
    res = adaptive_obj._filter_for_subfolder(versions, folder_criteria)
    print(f"\nres: {res}")
    assert res == [
        {"@id": "2", "@name": "FY23 - BOD PLAN", "@type": "PLANNING"},
        {"@id": "3", "@name": "FY23 - Adjusted BOD PLAN", "@type": "PLANNING"},
...
def test_exported_data_to_df(adaptive_obj):
    """
