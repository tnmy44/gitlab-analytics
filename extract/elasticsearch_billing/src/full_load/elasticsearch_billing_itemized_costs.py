...
def extract_load_billing_itemized_costs_full_load():
    """
    Extract and load Elastic Search Billing itemized costs from start 2023-01-01 till previous months_end_date
    """
