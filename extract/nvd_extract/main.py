...
def extract_data():
    ...
    has_response = True # Flag variable to check startIndex does not index resultsPerPage
    ...
    while has_response:
        ...
        try:
            ...
            startIndex = startIndex + resultsPerPage # Placing it here to fetch the last iteration of records which may be less than resultsPerPage
            time.sleep(3) # sleep for 3 seconds between each request to avoid rate limits.
        except requests.exceptions.RequestException :
            print("Error") # Raises exception if any https errors are encountered from the request.
            sys.exit(1)
extract_data()