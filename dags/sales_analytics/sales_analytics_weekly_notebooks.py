"""
Weekly Dag for Sales Analytics notebooks
"""
...
# Create the DAG
# Schedule to run weekly on Monday at 6AM
dag = DAG(
...
for notebook, task_name in notebooks.items():
    ...
    # Task 2
    sales_analytics_weekly_notebooks = KubernetesPodOperator(
        **gitlab_defaults,
        image=ANALYST_IMAGE,
    ...
    start >> sales_analytics_weekly_notebooks
