...
clone_data_science_ptpf_repo_cmd = f"""
    ...
    echo "git clone -b modify-ptpf-notebook --single-branch --filter=blob:none --no-checkout --depth 1 $REPO" &&
    git clone -b modify-ptpf-notebook --single-branch --filter=blob:none --no-checkout --depth 1 $REPO &&
