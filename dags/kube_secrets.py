...
# hyperproof
HYPERPROOF_CLIENT_ID = Secret("env", "HYPERPROOF_CLIENT_ID", "airflow", "HYPERPROOF_CLIENT_ID")
HYPERPROOF_CLIENT_SECRET = Secret("env", "HYPERPROOF_CLIENT_SECRET", "airflow", "HYPERPROOF_CLIENT_SECRET")
