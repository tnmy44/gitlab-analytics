...
TABLEAU_API_PUBLIC_TOKEN_NAME = Secret(
    "env", "TABLEAU_API_PUBLIC_TOKEN_NAME", "airflow", "TABLEAU_API_TOKEN_NAME"
)
TABLEAU_API_PUBLIC_TOKEN_SECRET = Secret(
    "env", "TABLEAU_API_PUBLIC_TOKEN_SECRET", "airflow", "TABLEAU_API_TOKEN_SECRET"
)
TABLEAU_API_PUBLIC_URL = Secret("env", "TABLEAU_API_PUBLIC_URL", "airflow", "TABLEAU_API_URL")
TABLEAU_API_PUBLIC_SITE_NAME = Secret(
    "env", "TABLEAU_API_PUBLIC_SITE_NAME", "airflow", "TABLEAU_API_SITE_NAME"
)
