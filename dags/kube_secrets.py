...
ZENDESK_SENSITIVE_SERVICE_ACCOUNT_CREDENTIALS = Secret("env", "ZENDESK_SENSITIVE_SERVICE_ACCOUNT_CREDENTIALS", "airflow", "ZENDESK_SENSITIVE_SERVICE_ACCOUNT_CREDENTIALS")
