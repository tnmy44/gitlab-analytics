...
TABLEAU_API_PUBLIC_TOKEN_SECRET = Secret(
    "env", "TABLEAU_API_PUBLIC_TOKEN_SECRET", "airflow", "TABLEAU_API_PUBLIC_TOKEN_SECRET"
)
TABLEAU_API_PUBLIC_URL = Secret("env", "TABLEAU_API_PUBLIC_URL", "airflow", "TABLEAU_API_PUBLIC_URL")
